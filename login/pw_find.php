		...
		<div id="login_form">
			 ...
			 <div id="login2">
				<div id="id_input_button">
					<fieldset>
                        <label for="name1" >이 름</label>
                        <input type="text" name="name" id="name1" class="find_input find_name" placeholder="이름 (ex. test)">
                        <label for="name2" >아이디</label>
                        <input type="text" name="id" id="name2" class="find_input find_id" placeholder="아이디 (ex. test)">
                        <div class="telBox">
