...
<body>
	...
	<article id="content">
      <a href="../index.html" class='Dsmelogo'></a>  
     ...
     <table>
      <caption class="hidden">회원가입</caption>
     	...
     	<tr>
     		<th class="hidden" scope="col"><label for="pass_confirm">비밀번호 확인</label></th>
     		<td>
     	...
     	<tr class="btn">
     		<td colspan="2">
     			<a href="#"  class="check_agree ok" onclick="check_input()">수정</a>
